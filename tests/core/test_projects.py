...
from delairstack.core.errors import (QueryError, UnsupportedOperationError)
...
class TestProjects(ResourcesTestBase):
    ...
    def test_create(self):
        ...
        self.assertDictEqual(json.loads(calls[0].request.body),
                             {'addProjectToUsers': True,
                              'analytics': {},
                              'linkOrCreateCardinalSite': False})
    ...
    def test_create_with_extra_args(self):
        ...
        project = self.sdk.projects.create(arg1='arg1', arg2=10)
    ...
    def test_delete_project(self):
        ...
        result_project = self.sdk.projects.delete(project='project-id')
