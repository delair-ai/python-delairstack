...
RASTER_TILES_URL_TEMPLATE = 'https://www.delair.ai/' \
    'tileserver/tiles/5d0b9952e8d1d25df4c1dd62/{z}/{x}/{y}.png' \
    '?access_token=FAKE_ACCESS_TOKEN'

VECTOR_TILES_URL_TEMPLATE = 'https://www.delair.ai/' \
...
class RequestsUtilsTests(TestCase):
    ...
    def test_generate_raster_tiles_url(self):
        url = generate_raster_tiles_url('https://www.delair.ai',
                                        'FAKE_ACCESS_TOKEN',
    ...
    def test_generate_vector_tiles_url(self):
        url = generate_vector_tiles_url('https://www.delair.ai',
                                        'FAKE_ACCESS_TOKEN',
                                        '5d0b9952e8d1d25df4c1dd62',
                                        'pbf')
