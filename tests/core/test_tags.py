...
from delairstack.core.resources.tags import Tag
...
class TestTags(ResourcesTestBase):
    ...
    def test_search_photo_tags(self):
        ...
        found_tags = self.sdk.tags.search(
            project='project-id',
            type='photo',
            target='ds-id',
            flight='flight-id')
        ...
        self.assertEqual(
            query_params,
            {'project_id': 'project-id', 'target_type': 'photo',
             'target_id': 'flight-id', 'target_subid': 'ds-id'}
        )
    ...
    def test_convert_uisrv_desc_to_Tag(self):
        ...
        assert tag._desc == Tag(
            ...
            creation_date='2019-12-25T00:00:00.000Z')._desc
    ...
    def test_convert_uisrv_desc_to_Tag_deleted(self):
        ...
        assert tag._desc == Tag(
            ...
            deletion_date='2019-12-25T00:00:00.000Z')._desc
