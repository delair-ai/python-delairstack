...
# delairstack.apis.client.projectmngt.projectsimpl.ProjectsImpl
...
htmlhelp_basename = 'delairstackdoc'
...
latex_documents = [
    (master_doc, 'delairstack.tex', 'python-delairstack Documentation',
     'Delair.ai Backend Team', 'manual'),
    ]
...
man_pages = [
    (master_doc, 'delairstack', 'python-delairstack Documentation',
     [author], 1)
    ]
...
texinfo_documents = [
    (master_doc, 'delairstack', 'python-delairstack Documentation',
     author, 'delairstack', 'One line description of project.',
     'Miscellaneous'),
    ]
